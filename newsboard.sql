...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Окт 12 2020 г., 20:22
...
CREATE TABLE `tags` (
  `id` int(11) NOT NULL,
  `idNews` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `tags` (`id`, `idNews`, `tag`) VALUES
(1, '1', 'site'),
(4, '1', 'internet'),
(5, '1', 'dev'),
(6, '2', 'test'),
